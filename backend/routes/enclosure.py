...
@enclosure.post("/enclosures", response_model= Enclosure, tags= ["Enclosures"], description="**Create** an enclosure.", response_description="Create enclosure")
...
@enclosure.get("/enclosures/{id}", response_model= Enclosure, tags= ["Enclosures"], description="**Return one** enclosure with Id.")
def get_enclosure(id: str):
    return conn.execute(enclosures.select().where(enclosures.c.id == id)).first()

@enclosure.get("/enclosures/delete/{id}", response_model= str, tags= ["Enclosures"], description="**Delete one** enclosure with Id.")
...
@enclosure.put("/enclosures/update/{id}", response_model= Enclosure, tags= ["Enclosures"], description="**Update** enclosure with Id.")
